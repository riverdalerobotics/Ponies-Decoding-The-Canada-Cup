...
public class RevThreeToSetVelo extends CommandBase {
    ...
    public RevThreeToSetVelo(ShooterSubsystem snap, ShooterSubsystem crackle, ShooterSubsystem pop, LimelightSubsystem limelight){
        ...
        this.speed = RobotConstants.Teleop.TEST_SHOOTING_SPEED;
    ...
    public RevThreeToSetVelo(ShooterSubsystem snap, ShooterSubsystem crackle, ShooterSubsystem pop, LimelightSubsystem limelight, boolean autoStop){
        this.snap = snap;
        this.crackle = crackle;
        this.pop = pop;
        this.limelight = limelight;
