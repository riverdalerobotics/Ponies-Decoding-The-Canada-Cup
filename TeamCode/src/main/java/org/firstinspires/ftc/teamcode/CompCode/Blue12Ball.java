...
@Autonomous(group = "COMP Auto", name = "Blue 12 Ball")
public class Blue12Ball extends CommandOpMode {
    ...
    public void initialize(){
        ...
        gate = new Pose2d(new Vector2d(0,-50),Math.toRadians(-150));
        ...
        pathFour = drive.actionBuilder(shoot)
                .strafeToLinearHeading(new Vector2d(8,-12), Math.toRadians(-90))
                .strafeToConstantHeading(new Vector2d(8, -63)).
                build();
        ...
        pathSix = drive.actionBuilder(shoot)
                .strafeToLinearHeading(new Vector2d(31,-20), Math.toRadians(-75))
                .strafeToLinearHeading(new Vector2d(31, -63), Math.toRadians(-105)).
                build();
