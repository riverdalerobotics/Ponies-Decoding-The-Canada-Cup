...
public class BlueFieldDefaultCommand extends CommandBase {
    ...
    public BlueFieldDefaultCommand(ChassisSubsystem chassisSubsystem, TelemetryManager telemetryManager,
                                   GamepadEx gamepadEx){
