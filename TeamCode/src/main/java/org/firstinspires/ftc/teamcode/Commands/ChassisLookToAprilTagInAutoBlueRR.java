...
public class ChassisLookToAprilTagInAutoBlueRR extends CommandBase {
    MecanumDrive chassisSubsystem;
    LLsubsystem limer;
    PIDController hPID;
     ...
     * */
    public ChassisLookToAprilTagInAutoBlueRR(MecanumDrive cSubsystem, LLsubsystem limelight, TelemetryManager telemetryManager, double targetAngle){
    ...
    public void execute(){
        ...
        if(limer.getLLResults().isValid()) {
            ...
            chassisSubsystem.setDrivePowers(new PoseVelocity2d(new Vector2d(0,0), -speed));
        }else{
            chassisSubsystem.setDrivePowers(new PoseVelocity2d(new Vector2d(0,0), 0.2));
        }
    }
    ...
    public void end(boolean interrupted) {
        ...
        hPID.reset();
        chassisSubsystem.setDrivePowers(new PoseVelocity2d(new Vector2d(0,0), 0));
    }
