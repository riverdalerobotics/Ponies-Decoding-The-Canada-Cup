package org.firstinspires.ftc.teamcode.Stampede.utility_code;
...
public class Stampede {
    ...
    public void initWheelHardware(boolean withEncoder) {
        ...
        driveFrontLeft = setUpEncoderMotor(RobotConstants.Hardware.FRONT_LEFT_MOTOR, DcMotor.Direction.FORWARD, 12, 10, 0.0, 5.0, withEncoder);
        driveFrontRight = setUpEncoderMotor(RobotConstants.Hardware.FRONT_RIGHT_MOTOR, DcMotor.Direction.FORWARD, 12, 10, 0.0, 5.0, withEncoder);
        driveRearLeft = setUpEncoderMotor(RobotConstants.Hardware.BACK_LEFT_MOTOR, DcMotor.Direction.REVERSE, 12, 10, 0.0, 5.0, withEncoder);
        driveRearRight = setUpEncoderMotor(RobotConstants.Hardware.BACK_RIGHT_MOTOR, DcMotor.Direction.REVERSE, 12, 10, 0.0, 5.0, withEncoder);
    ...
    public void init(HardwareMap ahwMap) {
        ...
        if (true) {
            ...
            configureOtos(RobotConstants.OTOS.X_OFFSET, RobotConstants.OTOS.Y_OFFSET, -90, 1, 1);
