...
//                intake far (2nd) line, gate, shoot 2nd line
    ...
    public void run(){
        ...
        telemetryManager.addData("SNAP current command", snap.getCurrentCommand());
        telemetryManager.addData("Snap Speed", snap.getSpeed());
        telemetryManager.addData("Pop Speed", pop.getSpeed());
        telemetryManager.addData("Crackle Speed", crackle.getSpeed());
